...
export default function Header(){
  const{user}=useContext(Usercontext)
    ...
    <header className=' flex justify-between'>
        <Link to={"/"} href="" className='flex items-center gap-1'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 -rotate-90">
        ...
        <div className='flex gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300'>
          <div>Anywhere</div>
          <div className="border border-l border-grray-300"></div>
          <div>Anyweek</div>
